...
import com.starling.exercise.roundup.clients.model.TransactionFeedItems.TransactionAmount;
...
public class StarlingStubs {
  ...
  public void stubTransactionFeed(Integer status) throws JsonProcessingException {
    final TransactionAmount amount = TransactionAmount.builder().minorUnits(1234).build();
